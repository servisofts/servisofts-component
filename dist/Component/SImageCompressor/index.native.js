...
var uriToFile = function (uri, props) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                var ___;
                return __generator(this, function (_a) {
                    ___ = fetch(uri).then(function (res) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            Image.compress(props.file.uri, {
                ...
                return __generator(this, function (_a) {
                    ...
                    resolve(__assign(__assign({}, props.file), { uri: resp }));
                    return [2 /*return*/];
                });
            }); })["catch"](function (e) {
                console.log(e);
