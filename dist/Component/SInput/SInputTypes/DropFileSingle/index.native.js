...
import { SText, SView, SImage } from '../../../../index';
// import DocumentPicker from 'react-native-document-picker';
// import ImagePicker from 'react-native-image-picker';
import { launchImageLibrary } from 'react-native-image-picker';
var DropFileSingle = /** @class */ (function (_super) {
    __extends(DropFileSingle, _super);
    function DropFileSingle(props) {
        var _this = _super.call(this, props) || this;
        _this.fileUpload = function () { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
    ...
    DropFileSingle.prototype.getFiles = function () {
        if (this.state.files.length <= 0) {
            return null;
        }
        return this.state.files.map(function (image, index) {
            console.log(image);
            return image;
        });
    };
