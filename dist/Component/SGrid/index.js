...
var SGrid = /** @class */ (function (_super) {
    ...
    SGrid.prototype.render = function () {
        var _this = this;
        return (React.createElement(Animated.View, { style: __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (!this.props.style.position ? {} : { position: this.props.style.position })), (!this.props.style.flex ? {} : { flex: this.props.style.flex })), (!this.props.flex ? {} : { flex: this.props.flex == true ? 1 : this.props.flex })), (!this.props.style.height ? {} : { height: this.props.style.height })), (!this.props.height ? {} : { height: this.props.height == true ? "100%" : this.props.height })), (!this.props.style.width ? {} : { width: this.props.style.width })), (!this.props.colSquare ? {} : { height: this.animSize.y })), (!this.props.style.zIndex ? {} : { zIndex: this.props.style.zIndex })), (this.props.style.margin == null ? {} : { top: this.props.style.margin })), (this.props.style.marginBottom == null ? {} : { top: this.props.style.marginBottom })), (this.props.style.marginTop == null ? {} : { top: this.props.style.marginTop })), (this.props.style.marginLeft == null ? {} : { top: this.props.style.marginLeft })), (this.props.style.marginRight == null ? {} : { top: this.props.style.marginRight })), (this.props.style.marginStart == null ? {} : { top: this.props.style.marginStart })), (this.props.style.marginEnd == null ? {} : { top: this.props.style.marginEnd })), (this.props.style.top == null ? {} : { top: this.props.style.top })), (this.props.style.bottom == null ? {} : { bottom: this.props.style.bottom })), (this.props.style.left == null ? {} : { left: this.props.style.left })), (this.props.style.right == null ? {} : { right: this.props.style.right })), (!this.props.col ? {} : {
