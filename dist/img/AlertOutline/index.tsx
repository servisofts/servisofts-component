...
const Web = (props) => (
    <svg {...props}
        ...
        <path d="M69.42,46.86a6.34,6.34,0,0,0-4.5,6.37c.14,1.84.26,3.7.4,5.54.39,7,.79,13.89,1.19,20.91a4.26,4.26,0,0,0,4.35,4.1,4.35,4.35,0,0,0,4.36-4.24c0-1.44,0-2.77.14-4.24.26-4.5.54-9,.8-13.5.14-2.91.39-5.82.53-8.74a7.27,7.27,0,0,0-.53-2.91A5.86,5.86,0,0,0,69.42,46.86Z" />
    </svg>
