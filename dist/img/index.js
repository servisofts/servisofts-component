...
var Icons = __assign({ MessageSend: MessageSend, Emoji: Emoji, Add: Add, Ajustes: Ajustes, AlertOutline: AlertOutline, Alert: Alert, Ambiente: Ambiente, Arrow: Arrow, Back: Back, Background: Background, Background2: Background2, Box: Box, Caja: Caja, Card: Card, Carrito: Carrito, Cerrar: Cerrar, Check: Check, Cheque: Cheque, Close: Close, Delete: Delete, Edit: Edit, Egreso: Egreso, Engranaje: Engranaje, Entrenamiento: Entrenamiento, Evento: Evento, Excel: Excel, Eyes: Eyes, Favorito: Favorito, Favorito2: Favorito2, Girl: Girl, Ingreso: Ingreso, Lock: Lock, LockOutline: LockOutline, Moon: Moon, Menu: Menu, Menu2: Menu2, Money: Money, NoDelete: NoDelete, Off: Off, Paquete: Paquete, Parameter: Parameter, Pencil: Pencil, Profanity: Profanity, Reload: Reload, Reserve: Reserve, Salir: Salir, Search: Search, Servisofts: Servisofts, Sun: Sun, Tranfer: Tranfer, Traspaso: Traspaso, Usuarios: Usuarios, "Icon2": Alert, Wifi: Wifi, WifiDisconnect: WifiDisconnect, World: World }, Svg);
